...
pubDate: "2019-07-08T01:53:59.000Z"
...
5. 日期加减函数：
   ...
   4. addtime()，
   5. period\_add(P,N)
6. date\_format(date, format) ，MySQL 日期格式化函数 date\_format()

       unix\_timestamp() 
       str\_to\_date(str, format) 
       from\_unixtime(unix\_timestamp, format) ，MySQL 时间戳格式化函数from\_unixtime
