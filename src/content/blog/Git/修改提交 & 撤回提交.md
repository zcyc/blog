---
title: "修改提交 & 撤回提交"
description: "修改提交# 注意：此修改方式会改变你修改的 commit 以及后边所有 commit 的时间  # 如果要修改的是最近一次，就使用如下命令 git commit --amend  # 如果要修改的是之前的，可以使用如下命令，此处的7是倒数第7个提交。如果是1，那么就是最新的提交。 git re..."
pubDate: "2021-06-30T15:50:53.000Z"
updatedDate: "2022-08-09T14:32:01.000Z"
