...
## REST
此处只列出部分方案，PHP 开发者可以用 Laravel 和 ThinkPHP 生成 REST 接口。[Strapi](https://github.com/strapi/strapi) 和 [Directus](https://github.com/directus/directus) 可以生成 CMS 接口，后者组件更多，但数据关联不好用。
### [Ruby on Rails](https://github.com/rails/rails)
Rails 可以使用 Resource routing 生成 REST 接口，包含 service 逻辑，写法非常灵活，不适合新手团队协作。
### [Phoenix Framework](https://github.com/phoenixframework/phoenix)
和 Rails 类似，使用 Elixir 语言，集合了 Erlang 和 Ruby 的优点。
